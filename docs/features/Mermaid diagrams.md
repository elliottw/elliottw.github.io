...
Quartz supports Mermaid which allows you to add diagrams and charts to your notes. Mermaid supports a range of diagrams, such as [flow charts](https://mermaid.js/syntax/flowchart.html), [sequence diagrams](https://mermaid.js/syntax/sequenceDiagram.html), and [timelines](https://mermaid.js/syntax/timeline.html). This is enabled as a part of [[Obsidian compatibility]] and can be configured and enabled/disabled from that plugin.
