...
## Why I didn't Choose an Alarm System {#why-i-didn-t-choose-an-alarm-system}
...
### Why I Didn't Choose to Reduce The Number of Keys {#why-i-didn-t-choose-to-reduce-the-number-of-keys}
...
## Someone Already Had the Solution {#someone-already-had-the-solution}

Nothing is new, and for a lot of inspiration on how to run a work community, I look to Alex Hillman at [IndyHall](http://www.indyhall/). He decided to put the responsibility of deciding who to trust back on the community. In his [Neighborhood Watch](http://dangerouslyawesome.com/) method, each new member has to get approval from several others to get a key.


## Introducing the Catapult Key Policy {#introducing-the-catapult-key-policy}

{{< figure src="/ox-hugo/20240403T030035--catapult-key-policy.jpg" >}}
